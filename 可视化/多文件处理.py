...
a=Line("钱江新区房价变化图")
a.add("平均价格",time, house, mark_line=["average"], mark_point=["max", "min"],xaxis_name="日期",yaxis_name="价格",yaxis_name_gap=60)
a.add("地铁房",time,house1,mark_point=["max", "min"],xaxis_name="日期",yaxis_name="价格",yaxis_name_gap=60)
a.add("学区房",time,house2,mark_point=["max", "min"],xaxis_name="日期",yaxis_name="价格",line_color='green',yaxis_name_gap=60)
a.add("车位房",time,house3,mark_point=["max", "min"],xaxis_name="日期",yaxis_name="价格",yaxis_name_gap=60)
a.show_config()
a.render(r"分类.html")
